...
const DICTIONARY: Record<string, any> = {
  id: {
    ...
    cover: {
      ...
      print: "CETAK DOKUMEN",
      service: "AksaraDiri Intelligence",
      logo: "P",
      ...
      footer: "AksaraDiri AI Architecture • {year}",
            ...
            <div className="p-16 print:p-12 relative">
              ...
              <div
                className="max-w-none text-stone-800 relative z-10 
                  ...
                  [&>p]:font-lora [&>p]:text-[13px] md:[&>p]:text-[14px] [&>p]:leading-[1.75] [&>p]:mb-5 [&>p]:text-justify [&>p]:text-stone-800/90
                  [&>h3+p]:first-letter:float-left [&>h3+p]:first-letter:text-5xl [&>h3+p]:first-letter:font-black [&>h3+p]:first-letter:font-mystic [&>h3+p]:first-letter:text-amber-900 [&>h3+p]:first-letter:pr-4 [&>h3+p]:first-letter:leading-[0.85] [&>h3+p]:first-letter:mt-1.5
                  [&>ul]:my-8 [&>ul]:space-y-4 [&>ul]:pl-5 [&>ul]:list-disc
                  [&>ul>li]:font-lora [&>ul>li]:text-[13px] md:[&>ul>li]:text-[14px] [&>ul>li]:leading-[1.75] [&>ul>li]:text-stone-700
                  [&>ul>li>strong]:font-bold [&>ul>li>strong]:text-stone-900
